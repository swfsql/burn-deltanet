...
//! than redundant. See
//! [`gated_deltanet`](crate::gated_deltanet::gated_deltanet) for the block and
//! the gate's parameterisation, and [`crate::delta`] for the recurrence.
//!
//! - [`gated_deltanet`](crate::gated_deltanet::gated_deltanet) — the block and
//!   its config.
//! - [`cache`](crate::gated_deltanet::cache) — the convolution window +
